...
struct FleetDriverListView: View {
    ...
    let hmvDrivers = [
        DriverListItem(driverName: "Angel Kenter", driverExperience: 4, driverImage: "driverImage"),
        DriverListItem(driverName: "Vikram Reddy", driverExperience: 5, driverImage: "driverImage"),
        DriverListItem(driverName: "Sonia Dsouza", driverExperience: 3, driverImage: "driverImage")
    ]
    
    let lmvDrivers = [
        DriverListItem(driverName: "Raj Mehra", driverExperience: 6, driverImage: "driverImage"),
        DriverListItem(driverName: "Sonia Dsouza", driverExperience: 3, driverImage: "driverImage"),
        DriverListItem(driverName: "Angel Kenter", driverExperience: 4, driverImage: "driverImage")
    ]
    
    var filteredDrivers: [DriverListItem] {
    ...
    var body: some View {
        NavigationView {
            VStack(spacing: 16) {
                ...
                // Hidden NavigationLink triggered by button
    ...
    @State private var selectedDriver: DriverListItem?
        ...
        private var driverList: some View {
            ...
            .fullScreenCover(item: $selectedDriver) { driver in
                NavigationStack {
    ...
    private func driverRow(_ driver: DriverListItem) -> some View {
        HStack(spacing: 16) {

    ...
    private var vehicleTypeRow: some View {
        HStack(spacing: 16) {
            ...
            Button(action: {
                ...
                HStack {
                    Text(vehicle.vehicleType == .HMV ? "HMV" : "LMV")
            ...
            .actionSheet(isPresented: $showingVehicleTypePicker) {
                ActionSheet(
                    ...
                    buttons: [
                        .default(Text("LMV")) { vehicle.vehicleType = .LMV },
                        .default(Text("HMV")) { vehicle.vehicleType = .HMV },
                        .cancel()
                    ]
                )
            }
...
struct FleetVehicle {
    ...
    var engineNo: String
    var licenceRenewedDate: String
    var distanceTravelled: String
    var averageMileage: String

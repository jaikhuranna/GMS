            ...
            VStack(spacing: 0) {
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 1) {
                        ...
                        HStack(spacing: 0) {
                            ContactInfoView(icon: "envelope.fill", text: "fleetmanger1331@gmail.com")
                        }
                        .padding(.top, 8)
                    }
...
struct ManagerProfileStatCard: View {
    let title: String
    let value: String
    let icon: String
    let color: Color
